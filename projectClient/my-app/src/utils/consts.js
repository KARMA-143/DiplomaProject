...
export const TASK_SCHEDULE_PAGE_ROUTE="/schedule";
export const TASK_LIST_ROUTE="/assignments";
export const CHECK_USER_TASK_PAGE = "/course/:id/task/:taskId/:userTaskId";
export const PASS_TEST_PAGE = "/course/:id/test/:testId/pass";
export const COMPLETE_TEST_PAGE = "/course/:id/test/:testId/:completeTestId";
export const CHAT_PAGE_ROUTE="/chat/:userId";